package top.song.chat.mail.receiver;
...
import top.song.chat.api.utils.JsonUtil;
...
public class FeedbackReceiver {
    ...
    @RabbitListener(queuesToDeclare = @Queue("${mail.queue.feedback:mail-queue-feedback}"))
