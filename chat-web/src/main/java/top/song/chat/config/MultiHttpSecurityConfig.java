...
import top.song.chat.api.entity.Admin;
import top.song.chat.api.entity.RespBean;
import top.song.chat.api.entity.User;
import top.song.chat.service.impl.AdminServiceImpl;
import top.song.chat.service.impl.UserServiceImpl;
...
public class MultiHttpSecurityConfig {
    ...
    public static class AdminSecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        public void configure(WebSecurity web) throws Exception {
            web.ignoring().antMatchers("/css/**", "/fonts/**", "/img/**", "/js/**", "/favicon.ico", "/index.html", "/admin/login", "/admin/mailVerifyCode", "/**/webjars/**", "/**/swagger-resources/**", "/**/v2/**", "/**/doc.html", "/**/swagger-ui.html");
        }
...
//    }
        ...
        @Override
        public void configure(WebSecurity web) throws Exception {
            web.ignoring().antMatchers("/login", "/verifyCode", "/file", "/user/register", "/user/checkUsername", "/messageType/**", "/messageContent/**", "/group/**", "/groupUserRelationship/**");
        }
